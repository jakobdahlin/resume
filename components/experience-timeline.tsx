...
export function ExperienceTimeline() {
  return (
    <div className="space-y-8">
            ...
            {/* First Company */}
            {/* Unified Jakob Dahlin Brand */}
<div className="space-y-4">
  <div>
    <div className="flex items-center gap-2">
      <h3 className="text-xl font-semibold">Founder, Photographer & Product Designer</h3>
    ...
    <p className="text-neutral-400">
      I run a multidisciplinary business under my own name where I work end-to-end across every branch of both digital product development and photography. That includes everything from finance, marketing, and client management to UX, engineering, branding, and content. Whether I'm building software or photographing buildings, I handle every part of the process myself—from concept to execution.
    </p>

    {/* Product Designer & UX Engineer */}
    <div className="border-l m-4 px-4">
    <h4 className="text-lg font-semibold text-white mt-6">Product Designer & UX Engineer</h4>
    ...
    <p className="text-neutral-400 pb-4">
      I design and build responsive, accessible websites and digital products that combine clean UX with strong visual design. My background in architectural photography sharpens my focus on structure, layout, and hierarchy. I work across all product functions—design, research, product management, engineering, and content design—to create functional and scalable experiences.
    </p>
...
{/* Third Company */}
    ...
    <p className="w-full text-neutral-400 text-md">
        ...
        and handled digital tasks such as organizing lists and creating marketing 
        ...
        <p className="w-full text-neutral-400 text-md">
        Managed the website, social media, and marketing materials for a project 
        that connected job seekers with companies through a custom-built platform. 
        Interviewed candidates and supported recruitment to help match companies 
        with the best possible applicants.
      </p>
        </div>
        </div>
        </div>
