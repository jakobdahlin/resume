...
<div className="space-y-4">
  ...
  font-medium text-primary text-white border border-gray-400/50">
    Current
  </span>
</span>
        </div>
        ...
        <div className="mt-1 text-sm text-muted-foreground">
            <div className="flex items-center gap-1 mb-3">
                ...
                <span className="text-gray-400">2016 - Present</span>
                <MapPin className="h-4 w-4 text-white ml-4" />
                <span className="text-gray-400">New York, NY (Hybrid)</span>
            </div>
        </div>
        <p className="w-full text-gray-400 text-md">
  ...
  <div className="flex items-center gap-2">
    ...
    text-white border border-gray-400/50">
  <span className="block rounded-full px-2.5 py-0.5 text-xs 
  ...
  <div className="mt-1 text-sm text-muted-foreground">
    <div className="flex items-center gap-1 mb-3">
      <CalendarDays className="h-4 w-4 text-white" />
      <span className="text-gray-400">2012 - Present</span>
      <MapPin className="h-4 w-4 text-white ml-4" />
      <span className="text-gray-400">New York, NY (Remote)</span>
    </div>
  </div>
...
responsive, user-friendly websites that reflect both functionality and aesthetics.</p>
    ...
    <div className="ml-2 border-l border-gray-400/50 pl-4">
        <div className="flex items-center gap-2">
              <h4 className="text-lg font-medium">Web Development</h4>
            </div>
            <ul className="mt-2 list-disc space-y-1 text-md text-gray-400 mb-2">
              <p>
      ...
      <div>
        ...
        <div className="mt-1 text-sm text-muted-foreground">
            <div className="flex items-center gap-1 mb-3">
                ...
                <MapPin className="h-4 w-4 text-white ml-4" />
                <span className="text-gray-400">Örebro, Sweden (On-Site)</span>
            </div>
        </div>
        <p className="w-full text-gray-400 text-md">
    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="mt-1 text-sm text-muted-foreground">
            <div className="flex items-center gap-1 mb-3">
                <CalendarDays className="h-4 w-4 text-white" />
                <span className="text-gray-400">2013 - 2014</span>
                <MapPin className="h-4 w-4 text-white ml-4" />
                <span className="text-gray-400">Örebro, Sweden (On-Site)</span>
            </div>
        </div>
