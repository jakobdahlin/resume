...
<div className="space-y-4">
  ...
  font-medium text-primary text-white">
    Current
        ...
        <p className="w-full text-neutral-500 text-md">
...
responsive, user-friendly websites that reflect both functionality and aesthetics.</p>
    ...
    <div className="ml-2 border-l border-neutral-700 border-border pl-4">
        <div className="flex items-center gap-2">
              <h4 className="text-lg font-medium">Web Development</h4>
            </div>
            <ul className="mt-2 list-disc space-y-1 text-md text-neutral-500 mb-2">
              <p>
      ...
      <div>
        ...
        <div className="mt-1 text-sm text-muted-foreground">
            <div className="flex items-center gap-1 mb-3">
                ...
                <span>2014 - 2016</span>
                <MapPin className="h-4 w-4 text-white ml-4" />
                <span>Örebro, Sweden (On-Site)</span>
            </div>
        </div>
        <p className="w-full text-neutral-500 text-md">
