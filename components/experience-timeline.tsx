...
<div className="space-y-4">
  ...
  font-medium text-primary text-white border border-cyan-300 shadow-lg shadow-cyan-400/50 animate-slow-pulse">
    Current
  </span>
</span>
        </div>
  ...
  <div className="flex items-center gap-2">
    ...
    text-white border border-cyan-300 animate-slow-pulse shadow-lg shadow-cyan-400/50">
  <span className="block rounded-full px-2.5 py-0.5 text-xs 
